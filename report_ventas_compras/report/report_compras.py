...
#                 if line.product_id.tipo_gasto == 'combustibles':
#                     taxes = line.tax_ids.compute_all(
...
#                             if 'importación' in inv.journal_id.name.lower():
#                                 servicios_i_gravados += (taxes['total_excluded'])
#                                 total_impo_g += (taxes['total_excluded'])
#                             else:
#                                 bienes_gravados += (taxes['total_excluded'])
#                                 total_bienes_g += (taxes['total_excluded'])
#                                 otros_impuestos_b = 0.00
#                                 retenciones_b = 0.00
#                         elif 'importación' in inv.journal_id.name.lower():
#                             bienes_i_exentos += taxes['total_excluded']
#                             total_impo_e += taxes['total_excluded']
#                         else:
...
#                                 retenciones_s = 0.00
#                         elif 'importación' in inv.journal_id.name.lower():
#                             servicios_i_exentos += taxes['total_excluded']
#                             total_impo_e += taxes['total_excluded']
#                         else:
...
#     _name = 'report.report_ventas_compras.report_purchase_book_guatemala'@api.model
#     def _get_report_values(self, docids, data=None):
#         company_id = data.get('form', {}).get(
#             'company_id', False)
#         if not company_id:
