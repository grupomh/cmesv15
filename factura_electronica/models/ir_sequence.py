...
class IrSequence(models.Model):
	...
	url_ws = fields.Char('URL Web Service Emisiones', required=False, help="Url para ingreso al Web Service WSDL")
	url_ws_anulacion = fields.Char('URL Web Service Anulaciones', required=False, help="Url para ingreso al Web Service WSDL")
	...
	tipo = fields.Selection([
		...
		('FACE-66', 'Factura Cambiaria Electronica'),
