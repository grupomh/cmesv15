...
class AccountJournal(models.Model):
    ...
    is_nota_abono = fields.Boolean('Nota de Abono', required=False, default=False)
...
class AccountTax(models.Model):
    ...
    active_fel = fields.Boolean('Factura Especial', required=False, defualt=False)
    type_fel = fields.Selection([
        ('IVA', 'IVA'),
        ('IDP', 'Impuesto a la Distribucion de Petroleo -IDP-'),
