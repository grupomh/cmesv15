...
class AccountInvoice(models.Model):
    ...
    def _manual_taxes(self):
        for data in self:
            ...
            for linea in data.amount_by_group:
                if linea[0] == 'ISV 15%':
                    data_dict['isv_15'] = linea[1]
                if linea[0] == '5% Contribución Especial CESC':
                    data_dict['cesc'] = linea[1]
                if linea[0] == 'IVA retenido':
                    data_dict['iva_retenido'] = linea[1]
                if linea[0] == 'IVA 13%':
                    data_dict['iva_13'] = linea[1]
            ...
            data.gravado_15 = data_dict['gravado_15']
            data.gravado_18 = data_dict['gravado_18']
    ...
    gravado_15 = fields.Monetary(compute="_manual_amount_gravado")
