...
class SaleOrder(models.Model):
    ...
    sales_commission_ids = fields.One2many('sale.commission.analysis','order_id',string="Comisiones de Ventas")
    show_commission = fields.Boolean(compute='check_show_commission',string="Mostrar comisiones")
